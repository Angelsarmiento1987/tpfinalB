...
const Navbar = () => {
    ...
    const[mostrarLinkUser, setMostrarLinkUser] = useState([])
    ...
    const buscarResultado = async (valorTag) => {
     ...
     const buscarInfoFoto = async (idFoto) => { 
        ...
        setMostrarLinkUser(data2.user.links)
        console.log(data2)
